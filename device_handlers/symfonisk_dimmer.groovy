/**
2020
Built upon the work of Luis Pinto
 i added debounce and start sending the dimming commands while turning the button
**/
import groovy.json.JsonOutput
import physicalgraph.zigbee.zcl.DataType

metadata {
    definition(name: "Ikea Symfonisk Dimmer/controller", namespace: "smartthings", author: "iesus", ocfDeviceType: "x.com.st.d.remotecontroller", mnmn: "SmartThings") {
        capability "Actuator"
        capability "Switch"
        capability "Button"
